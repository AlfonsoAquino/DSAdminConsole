...
public class ClasseSearchModel {
	...
	public synchronized ArrayList<Statistica> getClasse(String codiceClasse) {

		ArrayList<Statistica> stats=new ArrayList<Statistica>();
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		String logQuery="SELECT * FROM statitisticadislessia where codiceClasse=?";
		int temp=0;
		try {
